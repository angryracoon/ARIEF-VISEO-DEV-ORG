---
name: devops
description: "MUST BE USED for git operations, pull request creation, and final org deployment AFTER the user has merged the PR on GitHub. Uses developer-owned validation artifacts and defaults to fast delta deployment; scratch-org safety validation is conditional."
---
...
- Only `devops` may create PRs. No other agent creates PRs.
