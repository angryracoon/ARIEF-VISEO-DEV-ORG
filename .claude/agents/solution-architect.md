...
description: "MUST BE USED FIRST for every Salesforce implementation request. Analyzes requirements, classifies declarative and programmatic scope, asks clarifying questions if needed, produces a unified implementation specification for the downstream implementation agent, and creates the Git feature branch before implementation begins."
