---
name: main
description: "Routes every implementation request through one unified Salesforce delivery workflow and orchestrates specialist agents with strict handoff gates."
model: opus
color: blue
---
